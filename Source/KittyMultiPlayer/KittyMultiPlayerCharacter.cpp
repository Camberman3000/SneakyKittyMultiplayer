...
#include "KittyMultiPlayerProjectile.h"
...
//////////////////////////////////////////////////////////////////////////
// AKittyMultiPlayerCharacter

AKittyMultiPlayerCharacter::AKittyMultiPlayerCharacter()
{
...
void AKittyMultiPlayerCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void AKittyMultiPlayerCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	// Bind fire event
	PlayerInputComponent->BindAction("Fire", IE_Pressed, this, &AKittyMultiPlayerCharacter::OnFire);	 
	 
	// Bind movement events
	PlayerInputComponent->BindAxis("MoveForward", this, &AKittyMultiPlayerCharacter::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &AKittyMultiPlayerCharacter::MoveRight);

	// We have 2 versions of the rotation bindings to handle different kinds of devices differently
	// "turn" handles devices that provide an absolute delta, such as a mouse.
	// "turnrate" is for devices that we choose to treat as a rate of change, such as an analog joystick
	PlayerInputComponent->BindAxis("Turn", this, &APawn::AddControllerYawInput);
	PlayerInputComponent->BindAxis("TurnRate", this, &AKittyMultiPlayerCharacter::TurnAtRate);
	PlayerInputComponent->BindAxis("LookUp", this, &APawn::AddControllerPitchInput);
	PlayerInputComponent->BindAxis("LookUpRate", this, &AKittyMultiPlayerCharacter::LookUpAtRate);
}
...
bool AKittyMultiPlayerCharacter::Server_OnFire_Validate(FVector Location, FRotator Rotation)
{
	return true;
}
...
void AKittyMultiPlayerCharacter::MoveRight(float Value)
{
	if (Value != 0.0f)
	{
		// add movement in that direction
...
void AKittyMultiPlayerCharacter::TurnAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerYawInput(Rate * BaseTurnRate * GetWorld()->GetDeltaSeconds());
}

void AKittyMultiPlayerCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
