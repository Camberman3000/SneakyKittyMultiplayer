...
#include "KittyMultiPlayerCharacter.generated.h"
...
UCLASS(config=Game)
class AKittyMultiPlayerCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	TSubclassOf<class AKittyMultiPlayerProjectile> ProjectileClass;
